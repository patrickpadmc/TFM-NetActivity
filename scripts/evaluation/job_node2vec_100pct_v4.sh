#!/bin/bash
#SBATCH --job-name=n2v_100pct_v4
#SBATCH --output=/beegfs/home/ppadmoremcc/work/TFM-NetActivity/scripts/evaluation/logs/n2v_100pct_v4_%j.out
#SBATCH --error=/beegfs/home/ppadmoremcc/work/TFM-NetActivity/scripts/evaluation/logs/n2v_100pct_v4_%j.err
...
mkdir -p data/processed/evaluation/graph_v4/benchmark_multiscale/node2vec/100pct
python3 scripts/evaluation/run_node2vec_final_v4.py \
    ...
    --out-dir data/processed/evaluation/graph_v4/benchmark_multiscale/node2vec/100pct \
    --workers 16
