#!/bin/bash
#SBATCH --job-name=gat_uni_fixed_v4
#SBATCH --output=/beegfs/home/ppadmoremcc/work/TFM-NetActivity/scripts/evaluation/logs/gat_uniprot_fixed_v4_%j.out
#SBATCH --error=/beegfs/home/ppadmoremcc/work/TFM-NetActivity/scripts/evaluation/logs/gat_uniprot_fixed_v4_%j.err
...
mkdir -p data/processed/evaluation/graph_v4/gat_uniprot_fixed
