#!/bin/bash
#SBATCH --job-name=gae_subgraph_v4
#SBATCH --output=scripts/evaluation/logs/gae_subgraph_v4_%j.out
#SBATCH --error=scripts/evaluation/logs/gae_subgraph_v4_%j.err
