#!/bin/bash
#SBATCH --job-name=gae_uni_ft_v4
#SBATCH --output=/beegfs/home/ppadmoremcc/work/TFM-NetActivity/scripts/evaluation/logs/gae_uniprot_finetuned_v4_%j.out
#SBATCH --error=/beegfs/home/ppadmoremcc/work/TFM-NetActivity/scripts/evaluation/logs/gae_uniprot_finetuned_v4_%j.err
...
mkdir -p data/processed/evaluation/graph_v4/gae_uniprot_finetuned
python3 scripts/evaluation/run_gae_uniprot_v4.py \
    ...
    --out-dir data/processed/evaluation/graph_v4/gae_uniprot_finetuned \
