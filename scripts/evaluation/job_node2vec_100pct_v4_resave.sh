#!/bin/bash
#SBATCH --job-name=n2v_100p_resave_v4
#SBATCH --output=/beegfs/home/ppadmoremcc/work/TFM-NetActivity/scripts/evaluation/logs/n2v_100pct_resave_v4_%j.out
#SBATCH --error=/beegfs/home/ppadmoremcc/work/TFM-NetActivity/scripts/evaluation/logs/n2v_100pct_resave_v4_%j.err
