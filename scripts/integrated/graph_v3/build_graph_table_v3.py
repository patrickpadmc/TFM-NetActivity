#!/usr/bin/env python3
"""
build_graph_table_v3.py

Cambios respecto a v2:
  - ctddisease: ELIMINADO
  - ctdchemgen: EXPANDIDO de 3 a 10 relaciones
      Incluidas: upe, dwe, afe (ya en v2), upm, dwm, afm, upb, dwb, upa, dwa
      Excluidas: afb (affects abundance), afa (affects activity),
                 bnd (binding), loc (trafficking)
  - ctdchemis: NUEVO, 2 relaciones CPD-DIS
      CPD-cau-DIS (causes disease), CPD-trt-DIS (treats disease)
      Nota: estas aristas son CPD-DIS, ninguno de los dos nodos es GEN.
      v3 relaja la restriccion GEN-centrica de v2 para permitirlas
      explicitamente -- enriquecen el vecindario de nodos CPD y DIS.

Output en data/processed/integrated/graph_v3/:
...
Uso:
  python build_graph_table_v3.py [--base-dir PATH] [--out-dir PATH]
"""
import argparse
import os
import sys
...
RELATIONS = [
    ...
    # ctdchemgen -- expandido en v3 (10 relaciones, excluidas: afb, afa, bnd, loc)
    ...
    # ctdchemis -- NUEVO en v3 (CPD-DIS, primer tipo sin nodo GEN)
...
def compute_stats(df):
    """Calcula y devuelve las metricas globales del grafo."""
...
<head>
<meta charset="UTF-8">
<title>TFM-NetActivity - Knowledge Graph v3</title>
<link rel="stylesheet"
...
<body>
<div class="card">
  <h1>TFM-NetActivity -- Knowledge Graph v3</h1>
  <p>
  ...
  <p style="color:#666; font-size:0.85em;">
    Cambios vs v2: ctddisease eliminado &mdash;
    ctdchemgen expandido de 3 a 10 relaciones &mdash;
    ctdchemis anadido (CPD-DIS)
  </p>
</div>
<div class="card">
...
def main():
    ...
    out_dir  = args.out_dir or os.path.join(base, 'data', 'processed', 'integrated', 'graph_v3')
    os.makedirs(out_dir, exist_ok=True)

    print("=" * 60)
    print(" TFM-NetActivity -- build_graph_table_v3.py")
    print("=" * 60)
